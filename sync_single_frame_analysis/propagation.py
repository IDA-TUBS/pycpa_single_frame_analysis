...
| Copyright (C) 2007-2017 Jonas Diemer, Philip Axer, Johannes Schlatow, Jonas Peeck
...
class SyncPropagationEventModel(model.EventModel):
    ...
    def __init__(self, task, task_results, nonrecursive=True):
        ...
        model.EventModel.__init__(self,name,task.in_event_model.container)
        assert isinstance(task.in_event_model,model.SyncSampleEventModel) or isinstance(task.in_event_model,SyncPropagationEventModel)
