...
class ConstraintsManager(object):
    ...
    def __init__(self):
        ...
        # # synchronous task chain constraints
        self._sync_task_chain_constraints = dict()
    ...
    def add_sync_task_chain_constraint(self, sync_task_chain, deadline):
        assert isinstance(sync_task_chain.tasks[0].in_event_model, SyncEventModel)
        self._sync_task_chain_constraints[sync_task_chain] = deadline
...
class SyncEventModel (EventModel):
...
class SyncSampleEventModel(EventModel):
